...
variable "create_connection" {
  description = "If true, this module instance will create the service networking connection."
  type        = bool
  default     = false
}

variable "all_peering_range_names" {
  description = "A list of all peering range names that should be associated with this connection."
  type        = list(string)
  default     = []
}
