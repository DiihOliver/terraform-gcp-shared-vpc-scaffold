...
variable "jenkins_pool_display_name" {
  description = "The display name for the Jenkins Workload Identity Pool."
  type        = string
  default     = "Jenkins Development Pool"
}

variable "aws_account_id" {
  description = "The AWS account ID for the Workload Identity Provider."
  type        = string
}
